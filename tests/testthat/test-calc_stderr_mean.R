test_that("calc_stderr_mean: use", {
...
test_that("calc_stderr_mean: equivalent to suggestion of @bjoelle", {
  skip()
...
test_that("calc_stderr_mean: use, posterior", {
...
test_that("calc_stderr_mean: use, tree height", {
...
test_that("calc_stderr_mean: abuse", {
